...
A test in using the django cookiecutter
...
In your terminal, type or copy-paste the following:
    ...
    git clone git@github.com:jasonrfarkas/hello_world_django_cookies.git; cd hello_world_django_cookies; fab init
...
[contributing]: http://github.com/jasonrfarkas/hello_world_django_cookies/tree/master/CONTRIBUTING.md
